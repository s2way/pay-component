...
class PaymentCard extends Payment {
	...
	private $URL = null;
	private $token = null;
	private $processFields = array('issuer', 'card_number', 'due_date', 'security_code', 'card_holder', 'payment_type', 'installments', 'auth_token', 'no_authentication', 'save_card', 'return_url');
